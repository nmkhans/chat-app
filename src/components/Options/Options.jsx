...
import { useEditConversationMutation } from "../../redux/api/conversationApi";
...
const Options = ({ info }) => {
  ...
  const [editConversation, { data, isSuccess }] =
    useEditConversationMutation();

  const { sender, reciver } = info || {};
  ...
  const participantUser =
    sender.email === loggedInUser.email ? reciver : sender;
